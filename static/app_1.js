...
function handleBookingSubmit(e) {
    ...
    // In real application, here would be AJAX request to server
...
const originalHandleBookingSubmit = handleBookingSubmit;
const originalHandleQuickBookingSubmit = handleQuickBookingSubmit;

handleBookingSubmit = function(e) {
    const submitButton = e.target.querySelector('button[type="submit"]');
    addLoadingState(submitButton);
    return originalHandleBookingSubmit.call(this, e);
};

handleQuickBookingSubmit = function(e) {
    const submitButton = e.target.querySelector('button[type="submit"]');
    addLoadingState(submitButton);
    return originalHandleQuickBookingSubmit.call(this, e);
};
